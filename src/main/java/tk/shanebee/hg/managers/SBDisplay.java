...
public class SBDisplay {
    ...
    public SBDisplay(Game g) {
        ...
        this.ob = board.registerNewObjective(
                ChatColor.translateAlternateColorCodes('&', HG.getPlugin().getLang().players_alive), "dummy",
                "arena" + g.getName());
    ...
    public void setAlive() {
        /*
         * Score score = ob.getScore(ChatColor.translateAlternateColorCodes('&',
         * HG.getPlugin().getLang().players_alive)); Score arena =
         * ob.getScore(ChatColor.translateAlternateColorCodes('&',
         * HG.getPlugin().getLang().scoreboard_arena + g.getName()));
         * 
         * score.setScore(g.getPlayers().size()); arena.setScore(g.getPlayers().size() +
         * 1);
         * 
         */
        ob.unregister();
        ...
        this.ob.setDisplayName(ChatColor.translateAlternateColorCodes('&', HG.getPlugin().getLang().scoreboard_title));
        String alive = "  "
                + HG.getPlugin().getLang().players_alive_num.replace("<num>", String.valueOf(g.getPlayers().size()));
