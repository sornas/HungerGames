        ...
        if (!plugin.getPlayerSessions().containsKey(player.getUniqueId())) {
            ...
            if (!s.hasValidSelection()) {
                ...
                if (!Util.isInt(args[2]) || !Util.isInt(args[3]) || !Util.isInt(args[4])) {
                    ...
                    Bound b = new Bound(player.getWorld().getName(), l.getBlockX(), l.getBlockY(), l.getBlockZ(),
                            l2.getBlockX(), l2.getBlockY(), l2.getBlockZ());
                    plugin.getGames().add(new Game(args[1], b, Integer.parseInt(args[4]), Integer.parseInt(args[2]),
                            Integer.parseInt(args[3]), freeroam, cost));
