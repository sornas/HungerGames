...
public class MobEntry {
     ...
     */
    public void addGear(ItemStack hand, ItemStack offHand, ItemStack head, ItemStack chest, ItemStack legs,
            ItemStack feet) {
        this.hand = hand;
     ...
     * <p>
     * This is the message players will see when a player is killed by this mob type
     * </p>
     * 
    ...
    public void spawn(Location location) {
        ...
        if (!isMythic()) {
            ...
            if (deathMessage != null) {
                activeMob.getEntity().getBukkitEntity().setMetadata("death-message",
                        new FixedMetadataValue(HG.getPlugin(), deathMessage));
            }
        }
    }
    ...
    public String toString() {
        return "MobEntry{" + "type=" + type + ", name='" + name + '\'' + ", hand=" + hand + ", offHand=" + offHand
                + ", helmet=" + helmet + ", chest=" + chest + ", leggings=" + leggings + ", boots=" + boots
                + ", potionEffect=" + potionEffect + ", deathMessage='" + deathMessage + '\'' + ", mythic=" + mythic
                + ", mythicMob='" + mythicMob + '\'' + ", mythicLevel=" + mythicLevel + '}';
    }
