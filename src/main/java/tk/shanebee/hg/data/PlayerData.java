...
public class PlayerData {
    ...
    // Restores later if player has an item in their inventory which changes their
    // max health value
    ...
    public String toString() {
        return "PlayerData{" + "inv=" + Arrays.toString(inv) + ", equip=" + Arrays.toString(equip) + ", expLevel="
                + expL + ", expPoints=" + expP + ", health=" + health + ", food=" + food + ", saturation=" + saturation
                + ", mode=" + mode + ", uuid=" + uuid + ", team=" + team + ", pending=" + pendingTeam + ", game=" + game
                + '}';
    }
